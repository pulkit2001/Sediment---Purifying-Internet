...
function login() {
  ...
  browser.storage.sync.get("firsttime", function (obj) {
      if (obj.firsttime) {
          if (password) {
              set_password(password);
              browser.storage.sync.set({"firsttime": false});
	  ...
	  save_options();
        ...
        browser.storage.sync.get("password", function (obj) {
            try {
...
function set_password(password) {
    ...
    browser.storage.sync.set({"password": encryptedAES});
}
